    ...
    return (
      <div className="fixed bottom-4 right-4 z-50">
        <button
          ...
          className="bg-gradient-to-r from-discovery-gold to-discovery-gold-dark text-discovery-charcoal p-4 rounded-full shadow-xl hover:shadow-2xl transition-all duration-300"
